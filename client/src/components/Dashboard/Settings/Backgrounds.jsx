      ...
      <div className="backgrounds-container">
        <header>
          ...
          <p className="description">
            Choose the set of images as per your mood. When you choose an album,
            the images will change every midnight. If you choose an image, it
            will be static.
          </p>
        </header>
        <div className="body">
          <div className="tile-selection-list">
            <div
              onClick={() =>
                this.setState({ backgroundType: "albums", album: null })
              }
              className={
                "bordered-container " +
                (this.state.backgroundType === "albums" ? "active" : "")
              }
            >
              <div>
                <BiPhotoAlbum />
            ...
            <div
              onClick={() => this.setState({ backgroundType: "external" })}
              className={
                "bordered-container " +
                (this.state.backgroundType === "external" ? "active" : "")
              }
            >
              <div>
                <AiOutlineLink />
          ...
          <div
            className="albums-list-container"
            hidden={
              this.state.backgroundType !== "albums" ||
          ...
          >
            <div className="tile-selection-list">
              <div
                ...
                onClick={() => this.setState({ album: "All" })}
              >
              ...
              <div
                className="bordered-container"
                onClick={() => this.setState({ album: "Nature" })}
              >
              ...
              <div
                className="bordered-container"
                onClick={() => this.setState({ album: "Architecture" })}
              >
              ...
              <div
                className="bordered-container"
                onClick={() => this.setState({ album: "Pets" })}
              >
                ...
                <span className="tile-list-title">Pets</span>
              </div>
            </div>
          </div>
          {this.state.album !== null &&
            this.state.backgroundType === "albums" && (
              <AlbumImagesList
                ...
                onBack={this.closeAlbum.bind(this)}
                changeBackground={() => this.onBackgroundChange()}
              />
            )}
          {this.state.backgroundType === "external" &&
            this.getExternalUrlHtml()}
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="external-link-container">
        <input
          ...
          onChange={(e) => this.linkChanged(e)}
          type="text"
          placeholder="Paste your image address here"
        />
        <div className="help-section">
          <p>Need Help?</p>
          <button onClick={() => this.viewDemoImage()}>
            Checkout "how to" image.
          </button>
        </div>
        <button
          className="submit"
          onClick={() => this.changeToCustomBackground()}
        >
          Save
        </button>
      </div>
