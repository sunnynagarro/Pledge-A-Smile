...
// Constants
import { natureBgImages, architectureBgImages, allBgImages } from '../../../constants/bgImages.js';
        ...
        return (
            <div className="background-images-container">
                <div className="album-header">
                    <div className="album-back-button" onClick={() => this.goBack()}><IoIosArrowBack /> <span>Back</span></div>
                    ...
                    {this.state.images.map((image, i) => {
                        return (
                            <div key={i} className="bordered-container">
                                <span style={{'backgroundImage': 'url(' + image.url + ')'}} className="tile-list-image"></span>
                                <span onClick={() => this.setImageAsBackground(image)} className={'select-album ' + (this.state.background === image.url ? 'active' : '') }><RiCheckboxCircleFill /></span>
                            </div>
                        )
                    })}
                </div>
